...
from module.produto.domain.model import ProdutoCreate, ProdutoUpdate
from module.produto.domain.service import ValidacaoError
...
def get_controller(db_client):
    return ProdutoFacade().create_controller(db_client)
