...
class ProdutoRepository:
	...
	def insert_produto(self, produto):
		params = (produto.get("modalidade_id"), produto["codigo"], produto["nome"], produto.get("ativo", True))
	...
	def update_produto(self, produto_id, produto):
		params = (produto.get("modalidade_id"), produto["codigo"], produto["nome"], produto.get("ativo", True), produto_id)
