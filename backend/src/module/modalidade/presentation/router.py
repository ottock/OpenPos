...
from module.modalidade.domain.model import ModalidadeCreate, ModalidadeUpdate
from module.modalidade.domain.service import ValidacaoError
...
def get_controller(db_client):
    return ModalidadeFacade().create_controller(db_client)
