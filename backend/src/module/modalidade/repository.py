...
class ModalidadeRepository:
	...
	def insert_modalidade(self, modalidade):
		params = (modalidade["nome"], modalidade.get("descricao"), modalidade["tipo_reporte"])
	...
	def update_modalidade(self, modalidade_id, modalidade):
		params = (modalidade["nome"], modalidade.get("descricao"), modalidade["tipo_reporte"], modalidade_id)
